...
class Communicator {
  constructor() {
    ...
    this.storeServiceClient = axios.create({ baseURL: 'http://store-service:3002/api' });
    this.productServiceClient = axios.create({ baseURL: 'http://product-service:3003/api' });
    this.orderServiceClient = axios.create({ baseURL: 'http://order-service:3004/api' });
    this.cartServiceClient = axios.create({ baseURL: 'http://cart-service:3005/api' });
    this.authServiceClient = axios.create({ baseURL: 'http://auth-service:3006/api' });
  }
